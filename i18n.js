...
(function () {
  ...
  const DICT = {
    de: {
      ...
      // ── Register page (personal account) ──
      'reg.title': 'Konto erstellen',
      'reg.sub': 'Registriere dich – danach kannst du eine Feuerwehr erstellen oder einer beitreten.',
      'reg.name': 'Dein Name',
      'reg.namePh': 'z. B. Julian',
      'reg.email': 'E-Mail',
      'reg.emailPh': 'du@feuerwehr.ch',
      ...
      'reg.successBody': 'Wir haben dir eine Bestätigungs-E-Mail geschickt. Öffne den Link darin, um dein Konto zu aktivieren.',
      ...
      'login.sub': 'Melde dich mit deiner E-Mail an',
      'login.email': 'E-Mail',
      ...
      'onboarding.greeting': 'Willkommen,',
      'onboarding.sub': 'Erstelle eine Feuerwehr oder tritt einer bestehenden bei.',
      'onboarding.create.title': 'Feuerwehr erstellen',
      'onboarding.create.desc': 'Lege eine neue Feuerwehr an. Du wirst automatisch deren Administrator.',
      'onboarding.create.label': 'Name der Feuerwehr',
      'onboarding.create.namePh': 'z. B. FW Luzern',
      'onboarding.create.btn': 'Erstellen',
      'onboarding.join.title': 'Feuerwehr beitreten',
      'onboarding.join.desc': 'Du hast einen Einladungscode oder -link erhalten? Gib den Code hier ein.',
      'onboarding.join.label': 'Einladungscode',
      'onboarding.join.codePh': 'Code aus der E-Mail',
      'onboarding.join.btn': 'Beitreten',
      'onboarding.logout': 'Abmelden',
      'onboarding.creating': 'Wird erstellt…',
      'onboarding.joining': 'Beitreten…',
      'onboarding.errName': 'Bitte einen Namen eingeben.',
      'onboarding.errCode': 'Bitte einen gültigen Einladungscode eingeben.',
      'onboarding.errGeneric': 'Etwas ist schiefgelaufen. Bitte erneut versuchen.',
    },
    ...
    en: {
      ...
      'reg.sub': 'Sign up — then create a fire department or join one.',
      'reg.name': 'Your name',
      'reg.namePh': 'e.g. Julian',
      'reg.email': 'Email',
      'reg.emailPh': 'you@firebrigade.org',
      ...
      'reg.successBody': 'We have sent you a confirmation email. Open the link inside it to activate your account.',
      ...
      // ── Login page ──
      'login.title': 'Log in',
      'login.sub': 'Sign in with your email',
      'login.email': 'Email',
      ...
      'onboarding.greeting': 'Welcome,',
      'onboarding.sub': 'Create a fire department or join an existing one.',
      'onboarding.create.title': 'Create a department',
      'onboarding.create.desc': 'Set up a new fire department. You automatically become its administrator.',
      'onboarding.create.label': 'Department name',
      'onboarding.create.namePh': 'e.g. FW Luzern',
      'onboarding.create.btn': 'Create',
      'onboarding.join.title': 'Join a department',
      'onboarding.join.desc': 'Received an invite code or link? Enter the code here.',
      'onboarding.join.label': 'Invite code',
      'onboarding.join.codePh': 'Code from the email',
      'onboarding.join.btn': 'Join',
      'onboarding.logout': 'Log out',
      'onboarding.creating': 'Creating…',
      'onboarding.joining': 'Joining…',
      'onboarding.errName': 'Please enter a name.',
      'onboarding.errCode': 'Please enter a valid invite code.',
